...
from ..models.device_specs import DeviceSpecs, GprSector
...
def extract_device_specs_from_atpack(atpack_parser, device_name: str) -> DeviceSpecs:
...
def extract_all_device_specs_from_atpack(atpack_parser) -> List[DeviceSpecs]:
