...
ureg.define('°C = celsius')  # Ensure celsius is defined
    ...
    if " to " in voltage_range_str:
        try:
            ...
            if len(parts) == 2:
                ...
                if hasattr(min_voltage, 'magnitude') and hasattr(max_voltage, 'magnitude'):
...
def format_voltage_range(vdd_min: Union[str, pint.Quantity], vdd_max: Union[str, pint.Quantity]) -> str:
