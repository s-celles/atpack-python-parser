...
from .units import format_frequency, parse_frequency, parse_voltage_range, parse_temperature_range
...
def get_max_frequency_from_oscillators(oscillator_configs, device_name: str = "") -> str:
