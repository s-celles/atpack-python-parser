...
def compare_with_reference():
    ...
    try:
        ...
        validation_devices = ["PIC16F877A", "PIC16F84A", "PIC16F628A", "PIC16F688", "PIC16F883"]
        matches = 0
        mismatches = 0
        ...
        if matches == len(validation_devices):
            print("🎉 All validations passed! shadowidref handling is working correctly.")
        elif matches > mismatches:
            print("✅ Most validations passed. shadowidref handling appears to be working.")
        else:
